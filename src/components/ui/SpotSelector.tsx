...
export function SpotSelector() {
  ...
  return (
    <div className="pointer-events-auto absolute top-4 left-1/2 z-10 flex -translate-x-1/2 gap-1.5 overflow-x-auto rounded-xl border border-white/20 bg-black/40 p-1.5 backdrop-blur-md md:gap-2">
